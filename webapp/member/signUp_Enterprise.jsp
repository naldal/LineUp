			...
			<div class="container">
				...
				<div class="column is-center">
					...
					<div class="steps" id="stepsDemo">
						...
						<!-- //step line -->
						<div class="steps-content" style="margin: auto 80px;">
							<!-- step start -->
							<div class="step-content is-active">
								<h2 class="subtitle" style="margin-top: 100;">서비스 이용약관</h2>
								...
								<div style="margin-top: 50px;">
									<label class="checkbox"> <input type="checkbox"
										...
										class="text">모든 약관을 이해했으며 이에 동의합니다.</span>
									</label>
								</div>
							</div>
							<!-- //first step -->
							<form id="enterprise_form" >
								<div class="step-content has-text-centered" style="margin-top: 20px; margin-right: 100px; font-family:'Noto Sans KR', sans-serif;">
										...
										<div class="field-body">
											<div class="field">
												<div class="control has-icon has-icon-right">
													<input class="input" id="pwd" name="pwd" type="password" placeholder="Password" data-validate="require" />
												</div>
											</div>
										</div>
									</div>
									...
									<div class="field is-horizontal">
										...
										<div class="field-body">
											<div class="field">
												<div class="control has-icon has-icon-right">
													<input style="margin-top:11px" class="input" id="repwd" type="password"	name="repwd" id="repwd" placeholder="비밀번호 재확인" data-validate="require" />
												</div>
											</div>
										</div>
									</div>
									...
									<div class="field is-horizontal">
										<div class="field-label is-normal">
											<label class="label">사업자 이름</label>
										</div>
										<div class="field-body">
											<div class="field">
												<div class="control has-icon has-icon-right">
													<input class="input" type="text" name="real_name"
														id="real_name" placeholder="사업자이름" data-validate="require" />
												</div>
											</div>
										</div>
									</div>
									<div id="real_nameDiv"></div>
									<div class="field is-horizontal">
										<div class="field-label is-normal">
										...
										<div class="field-body">
											<div class="field">
												<div class="control has-icon has-icon-right">
													<input class="input" type="text" name="company_num"
														id="company_num" placeholder="사업자등록번호"
														data-validate="require" />
												</div>
											</div>
										</div>
									</div>
									<div id="company_numDiv"></div>
									<div class="field is-horizontal">
										<div class="field-label is-normal">
											...
											<div class="field">
												<div class="control has-icon has-icon-right">
													<input class="input" type="text" name="tel" id="tel"
														placeholder="전화번호" data-validate="require" />
												</div>
											</div>
										</div>
									</div>
						...
						<!-- step end -->
						<div class="steps-actions" style="margin-top: 30px;">
							<div class="steps-action">
								<a data-nav="previous" class="button is-light">이전으로</a>
							</div>
							<div class="steps-action">
								<a id="prev" class="custom_prev" data-nav="next"
									class="button is-light">다음으로</a>
							</div>
						</div>
					</div>
				</div>
